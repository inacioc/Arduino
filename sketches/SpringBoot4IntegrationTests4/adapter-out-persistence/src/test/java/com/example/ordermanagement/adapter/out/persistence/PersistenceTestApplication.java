 ...
 * <p>
 * There is no {@code @SpringBootApplication} in this module (that lives in the
 * {@code app} module), so the slice tests anchor on this configuration. It boots
 * only JPA + Liquibase + the persistence adapter beans — no web, no MQ, no batch.
 */
